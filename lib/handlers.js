...
handlers._checks.post = (data, callback) => {
  ...
  console.log('validProtocol: ', validProtocol);
  ...
  console.log('validSuccessCodes: ', validSuccessCodes);
  const validTimeoutSeconds = helpers.validateTimeoutSeconds(timeoutSeconds);
  console.log('validTimeoutSeconds: ', validTimeoutSeconds);

  // If inputs are valid
  if (validProtocol && validUrl && validMethod && validSuccessCodes && validTimeoutSeconds){
